...
export default function AdminProfileScreen({ navigation }) {
    ...
    useFocusEffect(
        useCallback(() => {
            ...
            if (route.params?.shouldRefreshProfile || route.params?.shouldRefreshAddress) {
                navigation.setParams({ shouldRefreshProfile: false, shouldRefreshAddress: false }); // Reset params
            }
            return () => {
                // Cleanup function
            };
